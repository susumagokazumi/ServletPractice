...
<body>
	...
	<form action="prodSave" method="post">
		<table>
			<tr>
				<th>商品ID</th>
				<td><input type="text" name="prodId" size="5"
					value="<c:out value='${prod.prodId}' />" readonly="readonly" /></td>
			</tr>
			<tr>
				<th>商品名</th>
				<td><input type="text" name="prodName" size="30"
					value="<c:out value='${prod.prodName}' />" /></td>
			</tr>
			<tr>
				<th>値段</th>
				<td><input type="text" name="price" size="10"
					value="<c:out value='${prod.price}' />" /></td>
			</tr>
		</table>
		<br>
